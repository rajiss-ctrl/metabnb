...
const PlaceToStay = ({showPop,handlePop}) => {
  return (
    <Box onClick={ !showPop && handlePop}>
      ...
      <Box>
        <Box padding={['0 30px','0 40px','0 80px','0 60px','0 60px']} margin={'60px 0'} fontFamily={'Red Rose'} display={'flex'}  justifyContent={'flex-start'} alignItems={'center'} flexDirection={['row']} flexWrap={['wrap','wrap','wrap','no-wrap','no-wrap']}>
        ...
        <Box  marginBottom={'43px'} padding={['0 15px','0 50px','0 10px','0 35px','0']} width={'100%'} display={'flex'} justifyContent={'center'} alignItems={'center'} gap={['15px','15px','15px','10px','15px']} flexWrap={'wrap'}>
          {CardItems.map((item)=>{
            return(
