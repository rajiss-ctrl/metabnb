   ...
   <>
    <Box  
        ...
        <Box paddingRight={['0','0','0','99px','99px']} width={['100%','100%','100%','60%','774px']}>
          <Heading color={'#434343'} fontSize={['30px','40px','40px','40px','50px']} letterSpacing={['-0.1em','','','','','-0.02em']} fontWeight={'400'} >Rent a <span style={{color:"#900664"}}>Place</span> away from <span style={{color:'#900664'}}>Home</span> in the <span style={{color:"#900664"}}>Metaverse</span> </Heading>
