   ...
   <>
    <Box  
        ...
        <Box paddingRight={['0','0','0','99px','99px']} width={['100%','100%','100%','60%','774px']}>
          ...
          <Text fontSize={['16px','16px','20px','20px','24px']} fontWeight={'400'} lineHeight={'35px'} color={'#434343'} margin={['25px 0 25.08px 0','25px 0 25.08px 0','25px 0 25.08px 0','20.08px 0 26.08px 0','20px 0 50.08px 0']} fontFamily={'Red Rose'}>we provide you access to luxury and affordable houses in the metaverse, get a chance to turn your imagination to reality at your comfort zone</Text>
